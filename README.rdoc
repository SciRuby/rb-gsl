...
Note that the code in the SciRuby/nmatrix repository is "as stable as possible." If you want to get involved, you should probably clone/fork from mohawkjohn/nmatrix or chriswailes/nmatrix:
