...
#
# Contents:
# 1. {Introduction}[link:files/ndlinear_rdoc.html#1]
# 1. {Class and methods}[link:files/ndlinear_rdoc.html#2]
# 1. {Examples}[link:files/ndlinear_rdoc.html#3]
#
...
#
#
# == {}[link:files/index_rdoc.html"name="2] Class and Methods
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Examples
