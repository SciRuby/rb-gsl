...
#
# Contents:
# 1. {Quasi-random number generator initialization}[link:files/qrng_rdoc.html#1]
# 1. {Sampling from a quasi-random number generator}[link:files/qrng_rdoc.html#2]
# 1. {Auxiliary quasi-random number generator functions}[link:files/qrng_rdoc.html#3]
# 1. {Saving and resorting quasi-random number generator state}[link:files/qrng_rdoc.html#4]
# 1. {Quasi-random number generator algorithms}[link:files/qrng_rdoc.html#5]
#
# == {}[link:files/index_rdoc.html"name="1] Quasi-random number generator initialization
#
# ---
# * GSL::QRng.alloc(T, d)
#
...
#
# == {}[link:files/index_rdoc.html"name="2] Sampling from a quasi-random number generator 
#
# ---
# * GSL::QRng::get(x)
#
#   This calculate the next point <tt>x</tt> from the sequence generator. Here <tt>x</tt> is an instance of the {GSL::Vector}[link:files/vector_rdoc.html] class. The space available for <tt>x</tt> must match the dimension of the generator. The point <tt>x</tt> will lie in the range 0 < x_i < 1 for each x_i. 
#
#   This is used as
...
#     end
#
# == {}[link:files/index_rdoc.html"name="3] Auxiliary quasi-random number generator functions 
#
# ---
# * GSL::QRng::name
#
...
#
#
# == {}[link:files/index_rdoc.html"name="4] Saving and resorting quasi-random number generator state
# ---
# * GSL::QRng::clone
# * GSL::QRng::duplicate
#
#   Return a newly created generator which is an exact copy of the generator <tt>self</tt>.
# == {}[link:files/index_rdoc.html"name="5] Quasi-random number generator algorithms
...
#
# {prev}[link:files/rng_rdoc.html]
# {next}[link:files/randist_rdoc.html]
#
