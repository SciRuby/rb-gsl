...
#
# Contents:
# 1. {Quasi-random number generator initialization}[link:qrng_rdoc.html#1]
# 1. {Sampling from a quasi-random number generator}[link:qrng_rdoc.html#2]
# 1. {Auxiliary quasi-random number generator functions}[link:qrng_rdoc.html#3]
# 1. {Saving and resorting quasi-random number generator state}[link:qrng_rdoc.html#4]
# 1. {Quasi-random number generator algorithms}[link:qrng_rdoc.html#5]
#
