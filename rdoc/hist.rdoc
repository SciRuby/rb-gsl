#
# = Histograms
# 1. {Histogram allocation}[link:hist_rdoc.html#1]
# 1. {Copying histograms}[link:hist_rdoc.html#2]
# 1. {Updating and accessing histogram elements}[link:hist_rdoc.html#3]
# 1. {Searching histogram ranges}[link:hist_rdoc.html#4]
# 1. {Histogram Statistics}[link:hist_rdoc.html#5]
# 1. {Histogram Operations}[link:hist_rdoc.html#6]
# 1. {Reading and writing histograms}[link:hist_rdoc.html#7]
# 1. {Extensions}[link:hist_rdoc.html#8]
#    1. {Histogram Operations}[link:hist_rdoc.html#8.1]
#    1. {Graph interface}[link:hist_rdoc.html#8.2]
#    1. {Histogram Fittings}[link:hist_rdoc.html#8.3]
# 1. {The histogram probability distribution}[link:hist_rdoc.html#9]
#
