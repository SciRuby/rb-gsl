...
#
# {RubyGSL}[http://rubyforge.org/projects/rb-gsl/"target="_top] is a Ruby 
# extension for GSL. This provides higher-level interfaces to the GSL functions.
#
# == {}[link:files/index_rdoc.html"name="1] Requirements
#   * GSL (1.4 or later recommended)
#   * ANSI C compiler
#   * Ruby (1.8 or later recommended)
#
# == {}[link:files/index_rdoc.html"name="2] Installation
# See {here}[link:files/index_rdoc.html].
#
# {next}[link:files/use_rdoc.html]
#
