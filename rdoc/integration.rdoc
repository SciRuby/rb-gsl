...
# Contents:
# 1. {Introduction}[link:integration_rdoc.html#1]
# 1. {QNG non-adaptive Gauss-Kronrod integration}[link:integration_rdoc.html#2]
# 1. {QAG adaptive integration}[link:integration_rdoc.html#3]
#    1. {GSL::Integration::Workspace class}[link:integration_rdoc.html#3.1]
#    1. {Methods}[link:integration_rdoc.html#3.2]
# 1. {QAGS adaptive integration with singularities}[link:integration_rdoc.html#4]
# 1. {QAGP adaptive integration with known singular points}[link:integration_rdoc.html#5]
# 1. {QAGI adaptive integration on infinite intervals}[link:integration_rdoc.html#6]
# 1. {QAWC adaptive integration for Cauchy principal values}[link:integration_rdoc.html#7]
# 1. {QAWS adaptive integration for singular functions}[link:integration_rdoc.html#8]
# 1. {QAWO adaptive integration for oscillatory functions}[link:integration_rdoc.html#9]
# 1. {QAWF adaptive integration for Fourier integrals}[link:integration_rdoc.html#10]
#
