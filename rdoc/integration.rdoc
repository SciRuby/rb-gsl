...
# Contents:
# 1. {Introduction}[link:files/integration_rdoc.html#1]
# 1. {QNG non-adaptive Gauss-Kronrod integration}[link:files/integration_rdoc.html#2]
# 1. {QAG adaptive integration}[link:files/integration_rdoc.html#3]
#    1. {GSL::Integration::Workspace class}[link:files/integration_rdoc.html#3.1]
#    1. {Methods}[link:files/integration_rdoc.html#3.2]
# 1. {QAGS adaptive integration with singularities}[link:files/integration_rdoc.html#4]
# 1. {QAGP adaptive integration with known singular points}[link:files/integration_rdoc.html#5]
# 1. {QAGI adaptive integration on infinite intervals}[link:files/integration_rdoc.html#6]
# 1. {QAWC adaptive integration for Cauchy principal values}[link:files/integration_rdoc.html#7]
# 1. {QAWS adaptive integration for singular functions}[link:files/integration_rdoc.html#8]
# 1. {QAWO adaptive integration for oscillatory functions}[link:files/integration_rdoc.html#9]
# 1. {QAWF adaptive integration for Fourier integrals}[link:files/integration_rdoc.html#10]
#
# == {}[link:files/index_rdoc.html"name="1] Introduction
...
# is provided as methods of {GSL::Function}[link:files/function_rdoc.html] objects.
...
# * <tt>f.integrate_xxx(a, b)</tt>, or <tt>f.xxx(a, b)</tt>
#
# == {}[link:files/index_rdoc.html"name="2] QNG non-adaptive Gauss-Kronrod integration
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] QAG adaptive integration
...
#
# === {}[link:files/index_rdoc.html"name="3.1] GSL::Integration::Workspace class
# ---
...
#
#
# ==== {}[link:files/index_rdoc.html"name="3.1.1] Algorithms which require the workspace
...
#
# === {}[link:files/index_rdoc.html"name="3.2] Methods
# ---
...
#
# == {}[link:files/index_rdoc.html"name="4] QAGS adaptive integration with singularities
...
#
# == {}[link:files/index_rdoc.html"name="5] QAGP adaptive integration with known singular points
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] QAGI adaptive integration on infinite intervals
# ---
...
#
# == {}[link:files/index_rdoc.html"name="7] QAWC adaptive integration for Cauchy principal values
# ---
...
#
# == {}[link:files/index_rdoc.html"name="8] QAWS adaptive integration for singular functions
...
#
# == {}[link:files/index_rdoc.html"name="9] QAWO adaptive integration for oscillatory functions
...
#         p f456.qawo(0.0, [0.0, 1e-10], table)
#
# == {}[link:files/index_rdoc.html"name="10] QAWF adaptive integration for Fourier integrals
# ---
...
#
# == {}[link:files/index_rdoc.html"name="11] Gauss-Legendre integration
# (GSL-1.14)
...
#
# {prev}[link:files/wavelet_rdoc.html]
# {next}[link:files/rng_rdoc.html]
#
