...
#
# Contents:
# 1. {Definitions}[link:rdoc/wavelet_rdoc.html#1]
# 1. {Initialization}[link:rdoc/wavelet_rdoc.html#2]
# 1. {Transform methods}[link:rdoc/wavelet_rdoc.html#3]
#    1. {Wavelet transforms in one dimension}[link:rdoc/wavelet_rdoc.html#3.1]
#    1. {Wavelet transforms in two dimension}[link:rdoc/wavelet_rdoc.html#3.2]
# 1. {Examples}[link:rdoc/wavelet_rdoc.html#4]
#
