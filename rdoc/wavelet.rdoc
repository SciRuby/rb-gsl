...
#
# Contents:
# 1. {Definitions}[link:files/wavelet_rdoc.html#1]
# 1. {Initialization}[link:files/wavelet_rdoc.html#2]
# 1. {Transform methods}[link:files/wavelet_rdoc.html#3]
# 1. {Wavelet transforms in one dimension}[link:files/wavelet_rdoc.html#3.1]
# 1. {Wavelet transforms in two dimension}[link:files/wavelet_rdoc.html#3.2]
# 1. {Examples}[link:files/wavelet_rdoc.html#4]
#
# == {}[link:files/index_rdoc.html"name="1] Definitions
#
...
#
# == {}[link:files/index_rdoc.html"name="2] Initialization
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Transform Methods
# === {}[link:files/index_rdoc.html"name="3.1] Wavelet transforms in one dimension
#
# ---
...
#
# === {}[link:files/index_rdoc.html"name="3.2] Wavelet transforms in two dimension
# ---
...
#   
# {prev}[link:files/fft_rdoc.html]
# {next}[link:files/integration_rdoc.html]
#
# {back}[link:files/index_rdoc.html]
#
