...
#
# Contents:
# 1. {Definitions}[link:wavelet_rdoc.html#1]
# 1. {Initialization}[link:wavelet_rdoc.html#2]
# 1. {Transform methods}[link:wavelet_rdoc.html#3]
#    1. {Wavelet transforms in one dimension}[link:wavelet_rdoc.html#3.1]
#    1. {Wavelet transforms in two dimension}[link:wavelet_rdoc.html#3.2]
# 1. {Examples}[link:wavelet_rdoc.html#4]
#
