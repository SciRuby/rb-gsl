...
#
# Contentes:
# 1. {Deriv methods}[link:files/diff_rdoc.html#1]
# 1. {Diff methods}[link:files/diff_rdoc.html#2]
#
# == {}[link:files/index_rdoc.html"name="1] Deriv methods (for GSL 1.4.90 or later)
...
#
# == {}[link:files/index_rdoc.html"name="2] Diff Methods (obsolete)
#
# ---
# * GSL::Diff.central(f, x)
# * GSL::Function#diff_central(x)
#
#   These compute the numerical derivative of the function <tt>f</tt> ( {GSL::Function}[link:files/function_rdoc.html] object) at the point <tt>x</tt> 
...
#      exact = 0.0000000000
#
# {prev}[link:files/interp_rdoc.html]
# {next}[link:files/cheb_rdoc.html]
#
