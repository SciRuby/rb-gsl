...
#
# The values to be stored are held in a {GSL::Vector}[link:files/vector_rdoc.html] or 
# a {GSL::Matrix}[link:files/matrix_rdoc.html] object,
...
#
# == {}[link:files/index_rdoc.html"name="1] The <tt>GSL::Ntuple</tt> class
# ---
...
#
# == {}[link:files/index_rdoc.html"name="2] Writing and reading ntuples
# ---
# * GSL::Ntuple#write
# * GSL::Ntuple#bookdata
#
...
#
# == {}[link:files/index_rdoc.html"name="3] Histogramming ntuple values
...
#   same histogram.
#
# {prev}[link:files/hist2d_rdoc.html]
# {next}[link:files/monte_rdoc.html]
#
