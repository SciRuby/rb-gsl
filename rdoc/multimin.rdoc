...
#
# Contents:
# 1. {Overview}[link:multimin_rdoc.html#1]
# 1. {Caveats}[link:multimin_rdoc.html#2]
# 1. {Initializing the Multidimensional Minimizer}[link:multimin_rdoc.html#3]
# 1. {Providing a function to minimize}[link:multimin_rdoc.html#4]
# 1. {Iteration}[link:multimin_rdoc.html#5]
# 1. {Stopping Criteria}[link:multimin_rdoc.html#6]
# 1. {Examples}[link:multimin_rdoc.html#7]
#    1. {FdfMinimizer}[link:multimin_rdoc.html#7.1]
#    1. {FMinimizer}[link:multimin_rdoc.html#7.2]
#
