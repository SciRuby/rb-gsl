...
#
# Contents:
# 1. {Overview}[link:files/multimin_rdoc.html#1]
# 1. {Caveats}[link:files/multimin_rdoc.html#2]
# 1. {Initializing the Multidimensional Minimizer}[link:files/multimin_rdoc.html#3]
# 1. {Providing a function to minimize}[link:files/multimin_rdoc.html#4]
# 1. {Iteration}[link:files/multimin_rdoc.html#5]
# 1. {Stopping Criteria}[link:files/multimin_rdoc.html#6]
# 1. {Examples}[link:files/multimin_rdoc.html#7]
# 1. {FdfMinimizer}[link:files/multimin_rdoc.html#7.1]
# 1. {FMinimizer}[link:files/multimin_rdoc.html#7.2]
#
...
#
# == {}[link:files/index_rdoc.html"name="2] Caveats
...
#
#
# == {}[link:files/index_rdoc.html"name="3] Initializing the Multidimensional Minimizer
# ---
...
#
# == {}[link:files/index_rdoc.html"name="4] Providing a function to minimize
...
#     my_func.set_params([1.0, 2.0])      # parameters
#
# == {}[link:files/index_rdoc.html"name="5] Iteration
# ---
...
#   starting point.
#
# == {}[link:files/index_rdoc.html"name="6] Stopping Criteria
...
#
# == {}[link:files/index_rdoc.html"name="7] Examples
#
# === {}[link:files/index_rdoc.html"name="7.1] FdfMinimizer
#      #!/usr/bin/env ruby
#      require("gsl")
#      include GSL::MultiMin
#
...
#
# === {}[link:files/index_rdoc.html"name="7.2] FMinimizer
#      #!/usr/bin/env ruby
#      require("gsl")
#      include GSL::MultiMin
#
...
#      end while status == GSL::CONTINUE and iter < 100
#
# {prev}[link:files/multiroot_rdoc.html]
# {next}[link:files/fit_rdoc.html]
#
