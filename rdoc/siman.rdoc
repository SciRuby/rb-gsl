#
# = Simulated Annealing
# === {}[link:files/index_rdoc.html"name="0.1] Library
#
# == {}[link:files/index_rdoc.html"name="1] Module and classes
#   * GSL::
#     * Siman::  (Module)
#       * Params (Class)
#       * Efunc (Class)
...
#       * Print (Class)
#
# == {}[link:files/index_rdoc.html"name="2] <tt>Siman</tt> Module
# === {}[link:files/index_rdoc.html"name="2.1] Singleton method
# ---
...
#      p x
#
# {prev}[link:files/monte_rdoc.html]
# {next}[link:files/odeiv_rdoc.html]
#
