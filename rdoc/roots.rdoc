...
#
# Contents:
# 1. {Solver classes}[link:roots_rdoc.html#1]
# 1. {Methods}[link:roots_rdoc.html#2]
#    1. {Methods to solve equations}[link:roots_rdoc.html#2.1]
#    1. {GSL::Function_fdf class: Providing the function to solve}[link:roots_rdoc.html#2.2]
#    1. {Search Stopping Parameters}[link:roots_rdoc.html#2.3]
# 1. {Higher-level interface}[link:roots_rdoc.html#3]
# 1. {Example}[link:roots_rdoc.html#4]
#
