...
#
# Contents:
# 1. {Solver classes}[link:files/roots_rdoc.html#1]
# 1. {Methods}[link:files/roots_rdoc.html#2]
#    1. {Methods to solve equations}[link:files/roots_rdoc.html#2.1]
#    1. {GSL::Function_fdf class: Providing the function to solve}[link:files/roots_rdoc.html#2.2]
#    1. {Search Stopping Parameters}[link:files/roots_rdoc.html#2.3]
# 1. {Higher-level interface}[link:files/roots_rdoc.html#3]
# 1. {Example}[link:files/roots_rdoc.html#4]
#
# == {}[link:files/index_rdoc.html"name="1] Solver classes
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="2] Methods
#
# ---
...
#   an instanse of the {GSL::Function}[link:files/function_rdoc.html] class.
#
# ---
...
#
#
# === {}[link:files/index_rdoc.html"name="2.1] Methods to solve equations
#
# ---
...
#
# === {}[link:files/index_rdoc.html"name="2.2] GSL::Function_fdf class: Providing the function to solve
# The <tt>FSolver</tt> object require an instance of the 
# {GSL::Function}[link:files/function_rdoc.html] class, which is already introduced elsewhere.
...
#
# === {}[link:files/index_rdoc.html"name="2.3] Search Stopping Parameters
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] High-level interface
# ---
...
#
# == {}[link:files/index_rdoc.html"name="4] Example
...
#      end while status != GSL::SUCCESS
#
# {prev}[link:files/dht_rdoc.html]
# {next}[link:files/min_rdoc.html]
#
