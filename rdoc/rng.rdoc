...
#
# Contents:
# 1. {General comments on random numbers}[link:rng_rdoc.html#1]
# 1. {The Random Number Generator Interface: GSL::Rng class}[link:rng_rdoc.html#2]
# 1. {Random number generator initialization}[link:rng_rdoc.html#3]
# 1. {Sampling from a random number generator}[link:rng_rdoc.html#4]
# 1. {Auxiliary random number generator functions}[link:rng_rdoc.html#5]
# 1. {Random number environment variables}[link:rng_rdoc.html#6]
#
