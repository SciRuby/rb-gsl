...
#
# Contents:
# 1. {General comments on random numbers}[link:files/rng_rdoc.html#1]
# 1. {The Random Number Generator Interface: GSL::Rng class}[link:files/rng_rdoc.html#2]
# 1. {Random number generator initialization}[link:files/rng_rdoc.html#3]
# 1. {Sampling from a random number generator}[link:files/rng_rdoc.html#4]
# 1. {Auxiliary random number generator functions}[link:files/rng_rdoc.html#5]
# 1. {Random number environment variables}[link:files/rng_rdoc.html#6]
#
# == {}[link:files/index_rdoc.html"name="1] General comments on random numbers
...
#
# == {}[link:files/index_rdoc.html"name="2] The Random Number Generator Interface 
...
# == {}[link:files/index_rdoc.html"name="3] Random number generator initialization 
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="4] Sampling from a random number generator
#
# ---
# * GSL::Rng#get
#
...
#
# == {}[link:files/index_rdoc.html"name="5] Auxiliary random number generator functions
#
# ---
# * GSL::Rng#name
#
...
#
# == {}[link:files/index_rdoc.html"name="6] Random number environment variables 
...
#
#
# {prev}[link:files/integration_rdoc.html]
# {next}[link:files/qrng_rdoc.html]
#
