...
#
# == {}[link:files/index_rdoc.html"name="1] Module structure
#   GSL::ALF (module)
#        GSL::ALF::Workspace (Class)
#
# == {}[link:files/index_rdoc.html"name="2] Creating ALF workspace
# ---
...
#
#   Sets various parameters for the subsequent computation of ALFs. If <tt>csphase</tt> is set to a non-zero value, the Condon-Shortley phase of (-1)^m will be applied to the associated Legendre functions. The Condon-Shortley phase is included by default. If <tt>cnorm</tt> is set to zero, the real normalization of the associated Legendre functions will be used. The default is to use complex normalization. The norm parameter defines the type of normalization which will be used. The possible values are as follows.
...
#
#   Returns the array index of results of <tt>Plm_array()</tt> and <tt>Plm_deriv_array()</tt> corresponding to P_l^m(x) and dP_l^m(x)/dx respectively. The index is given by l(l + 1)/2 + m.
#
#
