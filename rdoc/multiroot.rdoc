...
#
# 1. {Overview}[link:multiroot_rdoc.html#1]
# 1. {Initializing the Solver}[link:multiroot_rdoc.html#2]
# 1. {Providing the function to solve}[link:multiroot_rdoc.html#3]
# 1. {Iteration}[link:multiroot_rdoc.html#4]
# 1. {Search Stopping Parameters}[link:multiroot_rdoc.html#5]
# 1. {Higher Level Interface}[link:multiroot_rdoc.html#6]
# 1. {Examples}[link:multiroot_rdoc.html#7]
#    1. {FSolver}[link:multiroot_rdoc.html#7.1]
#    1. {FdfSolver}[link:multiroot_rdoc.html#7.2]
#
#
