...
#
# 1. {Overview}[link:files/multiroot_rdoc.html#1]
# 1. {Initializing the Solver}[link:files/multiroot_rdoc.html#2]
# 1. {Providing the function to solve}[link:files/multiroot_rdoc.html#3]
# 1. {Iteration}[link:files/multiroot_rdoc.html#4]
# 1. {Search Stopping Parameters}[link:files/multiroot_rdoc.html#5]
# 1. {Higher Level Interface}[link:files/multiroot_rdoc.html#6]
# 1. {Examples}[link:files/multiroot_rdoc.html#7]
# 1. {FSolver}[link:files/multiroot_rdoc.html#7.1]
# 1. {FdfSolver}[link:files/multiroot_rdoc.html#7.2]
#
#
...
#
#
# == {}[link:files/index_rdoc.html"name="3] Providing the function to solve
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] Higher Level Interface
# ---
...
#
# == {}[link:files/index_rdoc.html"name="7] Example
#
# === {}[link:files/index_rdoc.html"name="7.1] FSolver
#
#      proc = Proc.new { |x, params, f|
#        a = params[0];  b = params[1]
#        x0 = x[0];  x1 = x[1]
...
#
# === {}[link:files/index_rdoc.html"name="7.2] FdfSolver
#      n = 2
#
#      procf = Proc.new { |x, params, f|
#        a = params[0]; b = params[1]
...
#      end while status == GSL::CONTINUE and iter < 1000
#
# {prev}[link:files/min_rdoc.html]
# {next}[link:files/multimin_rdoc.html]
#
