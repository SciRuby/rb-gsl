...
#
# == {}[link:files/index_rdoc.html"name="4] Screenshot
#
# Ruby/GSL can be seen in action in these {screenshots}[link:files/screenshot_rdoc.html].
#
# == {}[link:files/index_rdoc.html"name="5] Reference
#
# The {Ruby/GSL reference manual}[link:files/ref_rdoc.html] follows and borrows
