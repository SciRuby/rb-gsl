...
#
# 1. {Interpolation classes}[link:files/interp_rdoc.html#1]
# 1. {Initializing interpolation objects}[link:files/interp_rdoc.html#2]
# 1. {Index Look-up and Acceleration}[link:files/interp_rdoc.html#3]
# 1. {Evaluation of Interpolating Functions}[link:files/interp_rdoc.html#4]
# 1. {Higher level interface: GSL::Spline class}[link:files/interp_rdoc.html#5]
# 1. {Class initialization}[link:files/interp_rdoc.html#5.1]
# 1. {Evaluation}[link:files/interp_rdoc.html#5.2]
# 1. {Finding and acceleration}[link:files/interp_rdoc.html#5.3]
#
# == {}[link:files/index_rdoc.html"name="1] Interpolation Classes
# * GSL
#   * Interp (class)
#     * Accel (class)
#   * Spline (class)
#   
# == {}[link:files/index_rdoc.html"name="2] Initializing interpolation objects
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Index Look-up and Acceleration 
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="4] Evaluation of Interpolating Functions 
#
# ---
...
#   data vectors <tt>xa</tt> and <tt>ya</tt>.
#
# == {}[link:files/index_rdoc.html"name="5] Higher level interface: GSL::Spline class
# === {}[link:files/index_rdoc.html"name="5.1] Class initialization
#
# ---
...
#
# === {}[link:files/index_rdoc.html"name="5.2] Evaluation
# ---
# * GSL::Spline#eval(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="5.3] Finding and acceleration
# ---
...
#
# {prev}[link:files/odeiv_rdoc.html]
# {next}[link:files/diff_rdoc.html]
#
