...
#
# 1. {Interpolation classes}[link:interp_rdoc.html#1]
# 1. {Initializing interpolation objects}[link:interp_rdoc.html#2]
# 1. {Index Look-up and Acceleration}[link:interp_rdoc.html#3]
# 1. {Evaluation of Interpolating Functions}[link:interp_rdoc.html#4]
# 1. {Higher level interface: GSL::Spline class}[link:interp_rdoc.html#5]
#    1. {Class initialization}[link:interp_rdoc.html#5.1]
#    1. {Evaluation}[link:interp_rdoc.html#5.2]
#    1. {Finding and acceleration}[link:interp_rdoc.html#5.3]
#
