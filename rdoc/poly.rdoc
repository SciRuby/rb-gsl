...
# = Polynomials
# Contents:
# 1. {Polynomial Evaluation}[link:files/poly_rdoc.html#1]
# 1. {Solving polynomial equations}[link:files/poly_rdoc.html#2]
# 1. {Quadratic Equations}[link:files/poly_rdoc.html#2.1]
# 1. {Cubic Equations}[link:files/poly_rdoc.html#2.2]
# 1. {General Polynomial Equations}[link:files/poly_rdoc.html#2.3]
# 1. {GSL::Poly Class}[link:files/poly_rdoc.html#3]
# 1. {Constructors}[link:files/poly_rdoc.html#3.1]
# 1. {Methods}[link:files/poly_rdoc.html#3.2]
# 1. {Polynomial Fitting}[link:files/poly_rdoc.html#4]
# 1. {Divided-difference representations}[link:files/poly_rdoc.html#5]
# 1. {Extensions}[link:files/poly_rdoc.html#6]
# 1. {Special Polynomials}[link:files/poly_rdoc.html#6.1]
# 1. {Polynomial Operations}[link:files/poly_rdoc.html#6.2]
#
# == {}[link:files/index_rdoc.html"name="1] Polynomial Evaluation
# ---
# * GSL::Poly.eval(c, x)
#
...
#
# == {}[link:files/index_rdoc.html"name="2] Solving polynomial equations
# === {}[link:files/index_rdoc.html"name="2.1] Quadratic Equations
# ---
...
#      [ 1.000e+00 2.000e+00 ]
#
# === {}[link:files/index_rdoc.html"name="2.2] Cubic Equations
# ---
...
#     z^3 + a z^2 + b z + c = 0
#
# === {}[link:files/index_rdoc.html"name="2.3] General Polynomial Equations
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] GSL::Poly Class
# This class expresses polynomials of arbitrary orders.
#
# === {}[link:files/index_rdoc.html"name="3.1] Constructors
# ---
...
#
# === {}[link:files/index_rdoc.html"name="3.2] Instance Methods
# ---
# * GSL::Poly#eval(x)
# * GSL::Poly#at(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="4] Polynomial fitting
# ---
...
#   {GSL::Multifit#linear}[link:files/fit_rdoc.html] in a case of polynomial fitting.
#
#   Example:
#     #!/usr/bin/env ruby
#     require("rbgsl")
...
#
# == {}[link:files/index_rdoc.html"name="5] Divided-difference representations
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] Extensions
# === {}[link:files/index_rdoc.html"name="6.1] Special Polynomials
# ---
# * GSL::Poly.hermite(n)
#
...
#  
# === {}[link:files/index_rdoc.html"name="6.2] Polynomial Operations
# ---
# * GSL::Poly#conv
# * GSL::Poly#deconv
# * GSL::Poly#reduce
...
#
#
# {prev}[link:files/complex_rdoc.html]
# {next}[link:files/sf_rdoc.html]
#
