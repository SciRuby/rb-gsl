...
# = Polynomials
# Contents:
# 1. {Polynomial Evaluation}[link:poly_rdoc.html#1]
# 1. {Solving polynomial equations}[link:poly_rdoc.html#2]
#    1. {Quadratic Equations}[link:poly_rdoc.html#2.1]
#    1. {Cubic Equations}[link:poly_rdoc.html#2.2]
#    1. {General Polynomial Equations}[link:poly_rdoc.html#2.3]
# 1. {GSL::Poly Class}[link:poly_rdoc.html#3]
#    1. {Constructors}[link:poly_rdoc.html#3.1]
#    1. {Methods}[link:poly_rdoc.html#3.2]
# 1. {Polynomial Fitting}[link:poly_rdoc.html#4]
# 1. {Divided-difference representations}[link:poly_rdoc.html#5]
# 1. {Extensions}[link:poly_rdoc.html#6]
#    1. {Special Polynomials}[link:poly_rdoc.html#6.1]
#    1. {Polynomial Operations}[link:poly_rdoc.html#6.2]
#
