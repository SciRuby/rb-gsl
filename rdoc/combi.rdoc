...
# = Combinations
# Contents:
# 1. {Combination allocation}[link:files/combi_rdoc.html#1]
# 1. {Methods}[link:files/combi_rdoc.html#2]
# 1. {Accessing combination elements}[link:files/combi_rdoc.html#2.1]
# 1. {Combination properties}[link:files/combi_rdoc.html#2.2]
# 1. {Combination functions}[link:files/combi_rdoc.html#2.3]
# 1. {Reading and writing combinations}[link:files/combi_rdoc.html#2.4]
#
# == {}[link:files/index_rdoc.html"name="1] Combination allocation
# ---
...
#
# === {}[link:files/index_rdoc.html"name="2.1] Accessing combination elements
# ---
...
#
# === {}[link:files/index_rdoc.html"name="2.2] Combination properties
# ---
# * GSL::Combination#n
#
...
#
# === {}[link:files/index_rdoc.html"name="2.3] Combination functions
# ---
...
#
# === {}[link:files/index_rdoc.html"name="2.4] Reading and writing combinations
# ---
...
#      end
#
# {prev}[link:files/perm_rdoc.html]
# {next}[link:files/multiset_rdoc.html]
#
