...
# = Combinations
# Contents:
# 1. {Combination allocation}[link:combi_rdoc.html#1]
# 1. {Methods}[link:combi_rdoc.html#2]
#    1. {Accessing combination elements}[link:combi_rdoc.html#2.1]
#    1. {Combination properties}[link:combi_rdoc.html#2.2]
#    1. {Combination functions}[link:combi_rdoc.html#2.3]
#    1. {Reading and writing combinations}[link:combi_rdoc.html#2.4]
#
