...
# = Error Handling
#
# == {}[link:files/index_rdoc.html"name="1] Error codes
...
#
# == {}[link:files/index_rdoc.html"name="2] Error handler
...
#
# {prev}[link:files/use_rdoc.html]
# {next}[link:files/math_rdoc.html]
#
