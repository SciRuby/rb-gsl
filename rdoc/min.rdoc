...
#
# Contents:
# 1. {Introduction}[link:min_rdoc.html#1]
# 1. {GSL::Min::FMinimizer class}[link:min_rdoc.html#2]
# 1. {Iteration}[link:min_rdoc.html#3]
# 1. {Stopping Parameters}[link:min_rdoc.html#4]
# 1. {Examples}[link:min_rdoc.html#5]
#
