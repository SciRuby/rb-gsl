...
#
# Contents:
# 1. {Introduction}[link:files/min_rdoc.html#1]
# 1. {GSL::Min::FMinimizer class}[link:files/min_rdoc.html#2]
# 1. {Iteration}[link:files/min_rdoc.html#3]
# 1. {Stopping Parameters}[link:files/min_rdoc.html#4]
# 1. {Examples}[link:files/min_rdoc.html#5]
#
...
# The function to minimize is given as an instance of the {GSL::Function}[link:files/function_rdoc.html] class to the minimizer.
#
#
# == {}[link:files/index_rdoc.html"name="2] GSL::Min::FMinimizer class
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Iteration
# ---
...
#   for the minimizer <tt>self</tt>.
#
# == {}[link:files/index_rdoc.html"name="4] Stopping Parameters
# ---
...
#
# == {}[link:files/index_rdoc.html"name="5] Example
...
#
# {prev}[link:files/roots_rdoc.html]
# {next}[link:files/multiroot_rdoc.html]
#
