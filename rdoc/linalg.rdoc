...
#
# Contents:
# 1. {LU Decomposition}[link:files/linalg_rdoc.html#1]
# 1. {QR Decomposition}[link:files/linalg_rdoc.html#2]
# 1. {QR Decomposition with Column Pivoting}[link:files/linalg_rdoc.html#3]
# 1. {Singular Value Decomposition}[link:files/linalg_rdoc.html#4]
# 1. {Cholesky Decomposition}[link:files/linalg_rdoc.html#5]
# 1. {Tridiagonal Decomposition of Real Symmetric Matrices}[link:files/linalg_rdoc.html#6]
# 1. {Tridiagonal Decomposition of Hermitian Matrices}[link:files/linalg_rdoc.html#7]
# 1. {Hessenberg Decomposition of Real Matrices}[link:files/linalg_rdoc.html#8]
# 1. {Hessenberg-Triangular Decomposition of Real Matrices}[link:files/linalg_rdoc.html#9]
# 1. {Bidiagonalization}[link:files/linalg_rdoc.html#10]
# 1. {Householder Transformations}[link:files/linalg_rdoc.html#11]
# 1. {Householder solver for linear systems}[link:files/linalg_rdoc.html#12]
# 1. {Tridiagonal Systems}[link:files/linalg_rdoc.html#13]
# 1. {Balancing}[link:files/linalg_rdoc.html#14]
# 1. {NArray}[link:files/linalg_rdoc.html#15]
#
# == {}[link:files/index_rdoc.html"name="1] LU Decomposition
# ---
...
#
# === {}[link:files/index_rdoc.html"name="1.1] {Complex LU decomposition}[link:files/linalg_complex_rdoc.html]
#
# == {}[link:files/index_rdoc.html"name="2] QR decomposition
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] QR Decomposition with Column Pivoting
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="4] Singular Value Decomposition
# ---
...
#       x = m.SV_solve(b)
#
# == {}[link:files/index_rdoc.html"name="6] Cholesky Decomposition
...
#
# === {}[link:files/index_rdoc.html"name="5.1] {Complex Cholesky decomposition}[link:files/cholesky_complex_rdoc.html]
#
# == {}[link:files/index_rdoc.html"name="6] Tridiagonal Decomposition of Real Symmetric Matrices 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="7] Tridiagonal Decomposition of Hermitian Matrices 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="8] Hessenberg Decomposition of Real Matrices 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="9] Hessenberg-Triangular Decomposition of Real Matrices 
# ---
...
#   of length <tt>N</tt>.
#
# == {}[link:files/index_rdoc.html"name="10] Bidiagonalization
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="11] Householder Transformations
# ---
...
#
# == {}[link:files/index_rdoc.html"name="12] Householder solver for linear systems
# ---
...
#
# == {}[link:files/index_rdoc.html"name="13] Tridiagonal Systems
# ---
...
#            ( e_3  0  e_2 d_3 )
#
# == {}[link:files/index_rdoc.html"name="14] Balancing
...
#
#
# == {}[link:files/index_rdoc.html"name="15] NArray
...
#     * HH.svx(m, bx)
#
# {prev}[link:files/blas_rdoc.html]
# {next}[link:files/eigen_rdoc.html]
#
