...
# 1. {QR Decomposition with Column Pivoting}[link:files/linalg_rdoc.html#4]
# 1. {Singular Value Decomposition}[link:files/linalg_rdoc.html#5]
# 1. {Cholesky Decomposition}[link:files/linalg_rdoc.html#6]
...
#       x = m.SV_solve(b)
#
# == {}[link:files/index_rdoc.html"name="5] Cholesky Decomposition
