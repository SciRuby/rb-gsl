...
# 1. {Usage:}[link:files/sf_rdoc.html#1]
# 1. {GSL::Sf::Result class}[link:files/sf_rdoc.html#2]
# 1. {Modes}[link:files/sf_rdoc.html#3]
# 1. {Airy functions}[link:files/sf_rdoc.html#4]
# 1. {Bessel functins}[link:files/sf_rdoc.html#5]
# 1. {Clausen functins}[link:files/sf_rdoc.html#6]
# 1. {Coulomb functins}[link:files/sf_rdoc.html#7]
# 1. {Coupling coefficients}[link:files/sf_rdoc.html#8]
# 1. {Dawson coefficients}[link:files/sf_rdoc.html#9]
# 1. {Debye coefficients}[link:files/sf_rdoc.html#10]
# 1. {Dilogarithm}[link:files/sf_rdoc.html#11]
# 1. {Elementary operations}[link:files/sf_rdoc.html#12]
# 1. {Elliptic integrals}[link:files/sf_rdoc.html#13]
# 1. {Elliptic functions}[link:files/sf_rdoc.html#14]
# 1. {Error functions}[link:files/sf_rdoc.html#15]
# 1. {Exponential functions}[link:files/sf_rdoc.html#16]
# 1. {Exponential integrals}[link:files/sf_rdoc.html#17]
# 1. {Fermi-Dirac function}[link:files/sf_rdoc.html#18]
# 1. {Gamma function}[link:files/sf_rdoc.html#19]
# 1. {Gegenbauer functions}[link:files/sf_rdoc.html#20]
# 1. {Hypergeometric functions}[link:files/sf_rdoc.html#21]
# 1. {Laguerre functions}[link:files/sf_rdoc.html#22]
# 1. {Lambert W functions}[link:files/sf_rdoc.html#23]
# 1. {Legendre functions and spherical harmonics}[link:files/sf_rdoc.html#24]
# 1. {Logarithm and related functions}[link:files/sf_rdoc.html#25]
# 1. {Mathieu functions}[link:files/sf_rdoc.html#26]
# 1. {Power function}[link:files/sf_rdoc.html#27]
# 1. {Psi (digamma) function}[link:files/sf_rdoc.html#28]
# 1. {Synchrotron functions}[link:files/sf_rdoc.html#29]
# 1. {Transport functions}[link:files/sf_rdoc.html#30]
# 1. {Trigonometric functions}[link:files/sf_rdoc.html#31]
# 1. {Zeta functions}[link:files/sf_rdoc.html#32]
#
# == {}[link:files/index_rdoc.html"name="1] Usage
...
#
# == {}[link:files/index_rdoc.html"name="2] <tt>GSL::Sf::Result</tt> Class
...
#   Returns the error.
#
# == {}[link:files/index_rdoc.html"name="3] Modes
...
#
# == {}[link:files/index_rdoc.html"name="4] Airy Functions and Derivatives
# ---
...
#
# === {}[link:files/index_rdoc.html"name="4.1] Derivatives of Airy Functions
# ---
...
#
# === {}[link:files/index_rdoc.html"name="4.2] Zeros of Airy Functions
# ---
...
#
# === {}[link:files/index_rdoc.html"name="4.3] Zeros of Derivatives of Airy Functions
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="5] Bessel Functions
# === {}[link:files/index_rdoc.html"name="5.1] Regular Cylindrical Bessel Functions
# ---
# * GSL::Sf::bessel_J0(x)
#
...
# === {}[link:files/index_rdoc.html"name="5.2] Irregular Cylindrical Bessel Functions
# ---
# * GSL::Sf::bessel_Y0(x)
#
...
#   and therefore may differ slightly from the exact values.
#
# === {}[link:files/index_rdoc.html"name="5.3] Regular Modified Cylindrical Bessel Functions
# ---
# * GSL::Sf::bessel_I0(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="5.4] Irregular Modified Cylindrical Bessel Functions
# ---
# * GSL::Sf::bessel_K0(x)
#
...
#   and therefore may differ slightly from the exact values.
#
# === {}[link:files/index_rdoc.html"name="5.5] Regular Spherical Bessel Functions
# ---
# * GSL::Sf::bessel_j0(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="5.6] Irregular Spherical Bessel Functions
# ---
# * GSL::Sf::bessel_y0(x)
#
...
#   and therefore may differ slightly from the exact values.
#
# === {}[link:files/index_rdoc.html"name="5.7] Regular Modified Spherical Bessel Functions
# ---
# * GSL::Sf::bessel_i0_scaled(x)
#
...
#   and therefore may differ slightly from the exact values.
#
# === {}[link:files/index_rdoc.html"name="5.8] Irregular Modified Spherical Bessel Functions
# ---
# * GSL::Sf::bessel_k0_scaled(x)
#
...
#   and therefore may differ slightly from the exact values.
#
# === {}[link:files/index_rdoc.html"name="5.9] Regular Bessel Function - Fractional Order
# ---
...
#
# === {}[link:files/index_rdoc.html"name="5.10] Irregular Bessel Functions - Fractional Order
# ---
...
#   Y_nu(x).
#
# === {}[link:files/index_rdoc.html"name="5.11] Regular Modified Bessel Functions - Fractional Order
# ---
...
#
# === {}[link:files/index_rdoc.html"name="5.12] Irregular Modified Bessel Functions - Fractional Order
# ---
...
#
# === {}[link:files/index_rdoc.html"name="5.13] Zeros of Regular Bessel Functions
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] Clausen Functions
# ---
# * GSL::Sf::clausen(x)
#
...
#
#
# == {}[link:files/index_rdoc.html"name="7] Coulomb Functions
# ---
...
#   psi(n,l,r) = R_n Y_{lm}.
#
# === {}[link:files/index_rdoc.html"name="7.1] Coulomb Wave Functions
# ---
...
#   <tt>eta</tt> to 0.
#
# === {}[link:files/index_rdoc.html"name="7.2] Coulomb Wave Function Normalization Constant
# ---
...
#
# == {}[link:files/index_rdoc.html"name="8] Coupling Coefficients
...
#   <tt>ja = two_ja/2, ma = two_ma/2</tt>, etc.
#
# == {}[link:files/index_rdoc.html"name="9] Dawson Function
...
#
# == {}[link:files/index_rdoc.html"name="10] Debye Functions
...
#
# == {}[link:files/index_rdoc.html"name="11] Dilogarithm
# === {}[link:files/index_rdoc.html"name="11.1] Real Argument
# ---
# * GSL::Sf::dilog(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="11.2] Complex Argument
# ---
...
#
# == {}[link:files/index_rdoc.html"name="12] Elementary Operations
...
#   the product as a <tt>GSL::Sf::Result</tt> object.
#
# == {}[link:files/index_rdoc.html"name="13] Elliptic Integrals
# === {}[link:files/index_rdoc.html"name="13.1] Legendre Form of Complete Elliptic Integrals
# ---
...
#   to the accuracy specified by the mode variable <tt>mode</tt>.
# === {}[link:files/index_rdoc.html"name="13.2] Legendre Form of Incomplete Elliptic Integrals
# ---
...
# === {}[link:files/index_rdoc.html"name="13.3] Carlson Forms
# ---
...
#   to the accuracy specified by the mode variable <tt>mode</tt>.
#
# == {}[link:files/index_rdoc.html"name="14] Elliptic Functions (Jacobi)
# ---
...
#
# == {}[link:files/index_rdoc.html"name="15] Error Functions
# ---
# * GSL::Sf::erf(x)
#
...
# === {}[link:files/index_rdoc.html"name="15.1] Probability functions
# ---
# * GSL::Sf::erf_Z(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="16] Exponential Functions
# ---
# * GSL::Sf::exp(x)
# * GSL::Sf::exp_e(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="16.1] Relative Exponential Functions
# ---
# * GSL::Sf::expm1(x)
#
...
#                  = 1F1 (1,1+N,x)
#
# === {}[link:files/index_rdoc.html"name="16.2] Exponentiation With Error Estimate
# ---
...
#   <tt>GSL::Sf::Result_e10</tt> type to return a result with extended range.
#
# == {}[link:files/index_rdoc.html"name="17] Exponential Integrals
# === {}[link:files/index_rdoc.html"name="17.1] Exponential Integral
# ---
# * GSL::Sf::expint_E1(x)
#
...
#
# === {}[link:files/index_rdoc.html"name="17.2] Ei(x)
# ---
# * GSL::Sf::expint_Ei(x)
#
...
# === {}[link:files/index_rdoc.html"name="17.3] Hyperbolic Integrals
# ---
# * GSL::Sf::Shi(x)
#
...
# === {}[link:files/index_rdoc.html"name="17.4] Ei_3(x)
# ---
# * GSL::Sf::expint_3(x)
#
#   Computes the exponential integral Ei_3(x) = int_0^x dt exp(-t^3) for x >= 0
# === {}[link:files/index_rdoc.html"name="17.5] Trigonometric Integrals
# ---
# * GSL::Sf::Si(x)
#
...
# === {}[link:files/index_rdoc.html"name="17.6] Arctangent Integral
# ---
# * GSL::Sf::atanint(x)
#
#   Computes the Arctangent integral AtanInt(x) = int_0^x dt arctan(t)/t.
#
# == {}[link:files/index_rdoc.html"name="18] Fermi-Dirac Functions
# === {}[link:files/index_rdoc.html"name="18.1] Complete Fermi-Dirac Integrals
...
# === {}[link:files/index_rdoc.html"name="18.2] Incomplete Fermi-Dirac Integrals
# ---
...
#
# == {}[link:files/index_rdoc.html"name="19] Gamma Function
...
#
# == {}[link:files/index_rdoc.html"name="20] Gegenbauer Functions
# ---
...
#
# == {}[link:files/index_rdoc.html"name="21] Hypergeometric Functions
# ---
...
#
# == {}[link:files/index_rdoc.html"name="22] Laguerre Functions
...
#
# == {}[link:files/index_rdoc.html"name="23] Lambert W Functions
...
#
# == {}[link:files/index_rdoc.html"name="24] Legendre Functions and Spherical Harmonics
# === {}[link:files/index_rdoc.html"name="24.1] Legendre Polynomials
# ---
...
#
# === {}[link:files/index_rdoc.html"name="24.2] Associated Legendre Polynomials and Spherical Harmonics
...
#   of P_l^m(x), lmax - m + 1.
#
# === {}[link:files/index_rdoc.html"name="24.3] Conical Functions
...
#
# === {}[link:files/index_rdoc.html"name="24.4] Radial Functions for Hyperbolic Space
...
#   and returns the result as a <tt>GSL::Vector</tt> object.
#
# == {}[link:files/index_rdoc.html"name="25] Logarithm and Related Functions
# ---
# * GSL::Sf::log(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="26] Mathieu functions
...
#
# === {}[link:files/index_rdoc.html"name="26.1] Mathieu Function Workspace 
...
#
# === {}[link:files/index_rdoc.html"name="26.2] Mathieu Function Characteristic Values 
# ---
...
#
# === {}[link:files/index_rdoc.html"name="26.3] Angular Mathieu Functions 
# ---
...
#   
# === {}[link:files/index_rdoc.html"name="26.4] Radial Mathieu Functions 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="27] Power Functions
# ---
# * GSL::Sf::pow_int(x, n)
...
#
# == {}[link:files/index_rdoc.html"name="28] Psi (Digamma) Function
...
#
# === {}[link:files/index_rdoc.html"name="28.1] Digamma Function
# ---
# * GSL::Sf::psi_int(n)
#
...
#
# === {}[link:files/index_rdoc.html"name="28.2] Trigamma Function
# ---
# * GSL::Sf::psi_1_int(n)
#
...
#
# === {}[link:files/index_rdoc.html"name="28.3] Polygamma Function
# ---
# * GSL::Sf::psi_n(m, x)
#
#   Computes the polygamma function psi^{(m)}(x) for m >= 0, x > 0.
#
# == {}[link:files/index_rdoc.html"name="29] Synchrotron Functions
# ---
...
#
# == {}[link:files/index_rdoc.html"name="30] Transport Functions
...
#
# == {}[link:files/index_rdoc.html"name="31] Trigonometric Functions
# === {}[link:files/index_rdoc.html"name="31.1] Circular Trigonometric Functions
# ---
# * GSL::Sf::sin(x)
# * GSL::Sf::cos(x)
# * GSL::Sf::hypot(x, y)
...
#
# === {}[link:files/index_rdoc.html"name="31.2] Trigonometric Functions for Complex Arguments
# ---
...
#
#
# === {}[link:files/index_rdoc.html"name="31.3] Hyperbolic Trigonometric Functions
# ---
# * GSL::Sf::lnsinh(x)
# * GSL::Sf::lncosh(x)
#
#
# === {}[link:files/index_rdoc.html"name="31.4] Conversion Functions
# ---
# * GSL::Sf::polar_to_rect(r, theta)
# * GSL::Sf::rect_to_polar(x, y)
#
#
# === {}[link:files/index_rdoc.html"name="31.5] Restriction Functions
# ---
...
#
# === {}[link:files/index_rdoc.html"name="31.6] Trigonometric Functions With Error Estimates
# ---
# * GSL::Sf::sin_err(x, dx)
#
...
#   cos(x +- dx).
#
# == {}[link:files/index_rdoc.html"name="32] Zeta Functions
# === {}[link:files/index_rdoc.html"name="32.1] Riemann Zeta Function
...
#
# === {}[link:files/index_rdoc.html"name="32.2] Riemann Zeta Function Minus One
# ---
# * GSL::Sf::zetam1_int(n)
#
...
#
# === {}[link:files/index_rdoc.html"name="32.3] Hurwitz Zeta Function
...
#
# === {}[link:files/index_rdoc.html"name="32.4] Eta Function
...
#
# {prev}[link:files/poly_rdoc.html]
# {next}[link:files/vector_rdoc.html]
#
