...
# 1. {Usage:}[link:sf_rdoc.html#1]
# 1. {GSL::Sf::Result class}[link:sf_rdoc.html#2]
# 1. {Modes}[link:sf_rdoc.html#3]
# 1. {Airy functions}[link:sf_rdoc.html#4]
# 1. {Bessel functins}[link:sf_rdoc.html#5]
# 1. {Clausen functins}[link:sf_rdoc.html#6]
# 1. {Coulomb functins}[link:sf_rdoc.html#7]
# 1. {Coupling coefficients}[link:sf_rdoc.html#8]
# 1. {Dawson coefficients}[link:sf_rdoc.html#9]
# 1. {Debye coefficients}[link:sf_rdoc.html#10]
# 1. {Dilogarithm}[link:sf_rdoc.html#11]
# 1. {Elementary operations}[link:sf_rdoc.html#12]
# 1. {Elliptic integrals}[link:sf_rdoc.html#13]
# 1. {Elliptic functions}[link:sf_rdoc.html#14]
# 1. {Error functions}[link:sf_rdoc.html#15]
# 1. {Exponential functions}[link:sf_rdoc.html#16]
# 1. {Exponential integrals}[link:sf_rdoc.html#17]
# 1. {Fermi-Dirac function}[link:sf_rdoc.html#18]
# 1. {Gamma function}[link:sf_rdoc.html#19]
# 1. {Gegenbauer functions}[link:sf_rdoc.html#20]
# 1. {Hypergeometric functions}[link:sf_rdoc.html#21]
# 1. {Laguerre functions}[link:sf_rdoc.html#22]
# 1. {Lambert W functions}[link:sf_rdoc.html#23]
# 1. {Legendre functions and spherical harmonics}[link:sf_rdoc.html#24]
# 1. {Logarithm and related functions}[link:sf_rdoc.html#25]
# 1. {Mathieu functions}[link:sf_rdoc.html#26]
# 1. {Power function}[link:sf_rdoc.html#27]
# 1. {Psi (digamma) function}[link:sf_rdoc.html#28]
# 1. {Synchrotron functions}[link:sf_rdoc.html#29]
# 1. {Transport functions}[link:sf_rdoc.html#30]
# 1. {Trigonometric functions}[link:sf_rdoc.html#31]
# 1. {Zeta functions}[link:sf_rdoc.html#32]
#
