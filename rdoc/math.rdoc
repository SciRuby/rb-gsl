...
# Contents:
# 1. {Mathematical Constants}[link:files/math_rdoc.html#1]
#    1. {Infinities and Not-a-number}[link:files/math_rdoc.html#2]
#    1. {Constants}[link:files/math_rdoc.html#2.1]
# 1. {Module functions}[link:files/math_rdoc.html#2.2]
# 1. {Elementary Functions}[link:files/math_rdoc.html#3]
# 1. {Small Integer Powers}[link:files/math_rdoc.html#4]
# 1. {Testing the Sign of Numbers}[link:files/math_rdoc.html#5]
# 1. {Testing for Odd and Even Numbers}[link:files/math_rdoc.html#6]
# 1. {Maximum and Minimum functions}[link:files/math_rdoc.html#7]
# 1. {Approximate Comparison of Floating Point Numbers}[link:files/math_rdoc.html#8]
#
# == {}[link:files/index_rdoc.html"name="1] Mathematical Constants
# ---
# * GSL::M_E
#
...
#   Euler's constant
#
# == {}[link:files/index_rdoc.html"name="2] Infinities and Not-a-number
#
# === {}[link:files/index_rdoc.html"name="2.1] Constants
# ---
# * GSL::POSINF
#
...
#
# === {}[link:files/index_rdoc.html"name="2.2] Module functions
# ---
# * GSL::isnan(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="3] Elementary Functions
# ---
# * GSL::log1p(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="4] Small Integer Powers
# ---
# * GSL::pow_int(x, n)
#
...
#   efficiently.
#
# == {}[link:files/index_rdoc.html"name="5] Testing the Sign of Numbers
# ---
# * GSL::SIGN(x)
# * GSL::sign(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="6] Testing for Odd and Even Numbers
# ---
# * GSL::is_odd(n)
# * GSL::IS_ODD(n)
#
...
#
# == {}[link:files/index_rdoc.html"name="7] Maximum and Minimum functions
# ---
# * GSL::max(a, b)
# * GSL::MAX(a, b)
# * GSL::min(a, b)
...
#
#   
# == {}[link:files/index_rdoc.html"name="8] Approximate Comparison of Floating Point Numbers
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="9] Module Constants
# ---
# * GSL::VERSION
#
#   GSL version
...
#   Ruby/GSL version
#
# {prev}[link:files/ehandling_rdoc.html]
# {next}[link:files/complex_rdoc.html]
#
