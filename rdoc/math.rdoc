...
# Contents:
# 1. {Mathematical Constants}[link:math_rdoc.html#1]
#    1. {Infinities and Not-a-number}[link:math_rdoc.html#2]
#    1. {Constants}[link:math_rdoc.html#2.1]
# 1. {Module functions}[link:math_rdoc.html#2.2]
# 1. {Elementary Functions}[link:math_rdoc.html#3]
# 1. {Small Integer Powers}[link:math_rdoc.html#4]
# 1. {Testing the Sign of Numbers}[link:math_rdoc.html#5]
# 1. {Testing for Odd and Even Numbers}[link:math_rdoc.html#6]
# 1. {Maximum and Minimum functions}[link:math_rdoc.html#7]
# 1. {Approximate Comparison of Floating Point Numbers}[link:math_rdoc.html#8]
#
