...
# = Sorting
# Contents:
# 1. {Heapsort of vectors}[link:sort_rdoc.html#1]
# 1. {Sorting vectors}[link:sort_rdoc.html#2]
# 1. {Selecting the k smallest or largest elements}[link:sort_rdoc.html#3]
#
