...
# = Sorting
# Contents:
# 1. {Heapsort of vectors}[link:files/sort_rdoc.html#1]
# 1. {Sorting vectors}[link:files/sort_rdoc.html#2]
# 1. {Selecting the k smallest or largest elements}[link:files/sort_rdoc.html#3]
#
# == {}[link:files/index_rdoc.html"name="1] Heapsort
#
# ---
# * GSL::Vector#heapsort
...
#   
# == {}[link:files/index_rdoc.html"name="2] Sorting vectors
# ---
# * GSL::Vector#sort!
#
...
#
# == {}[link:files/index_rdoc.html"name="3] Selecting the k smallest or largest elements
# ---
...
#
#
# {prev}[link:files/multiset_rdoc.html]
# {next}[link:files/blas_rdoc.html]
#
