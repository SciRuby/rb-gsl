#
# = Statistics
# 1. {Mean, Standard Deviation and Variance}[link:files/stats_rdoc.html#1]
# 1. {Absolute deviation}[link:files/stats_rdoc.html#2]
# 1. {Higher moments (skewness and kurtosis)}[link:files/stats_rdoc.html#3]
# 1. {Autocorrelation}[link:files/stats_rdoc.html#4]
# 1. {Covariance}[link:files/stats_rdoc.html#5]
# 1. {Correlation}[link:files/stats_rdoc.html#6]
# 1. {Weighted samples}[link:files/stats_rdoc.html#7]
# 1. {Maximum and minimum values}[link:files/stats_rdoc.html#8]
# 1. {Median and percentiles}[link:files/stats_rdoc.html#9]
# 1. {Examples}[link:files/stats_rdoc.html#10]
#
# == {}[link:files/index_rdoc.html"name="1] Mean, Standard Deviation and Variance
#
# ---
# * GSL::Stats::mean(v)
# * GSL::Vector#mean
...
#   <tt>mean</tt> of the underlying distribution is known <tt>a priori</tt>.
#
# == {}[link:files/index_rdoc.html"name="2] Absolute deviation 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Higher moments (skewness and kurtosis) 
#
# ---
...
#   Kurtosis
#
# == {}[link:files/index_rdoc.html"name="4] Autocorrelation
# ---
...
#
# == {}[link:files/index_rdoc.html"name="5] Covariance
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] Correlation
# ---
...
#
# == {}[link:files/index_rdoc.html"name="7] Weighted samples
# ---
# * GSL::Vector#wmean(w)
...
#
#
# == {}[link:files/index_rdoc.html"name="8] Maximum and Minimum values 
# ---
# * GSL::Stats::max(data)
# * GSL::Vector#max
#
...
#
#
# == {}[link:files/index_rdoc.html"name="9] Median and Percentiles 
#
# ---
...
#   should always be used first.
#
# == {}[link:files/index_rdoc.html"name="10] Example
#
#      #!/usr/bin/env ruby
#      require 'gsl'
#
...
#
# {prev}[link:files/randist_rdoc.html]
# {next}[link:files/hist_rdoc.html]
#
