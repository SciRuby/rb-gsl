#
# = Statistics
# 1. {Mean, Standard Deviation and Variance}[link:stats_rdoc.html#1]
# 1. {Absolute deviation}[link:stats_rdoc.html#2]
# 1. {Higher moments (skewness and kurtosis)}[link:stats_rdoc.html#3]
# 1. {Autocorrelation}[link:stats_rdoc.html#4]
# 1. {Covariance}[link:stats_rdoc.html#5]
# 1. {Correlation}[link:stats_rdoc.html#6]
# 1. {Weighted samples}[link:stats_rdoc.html#7]
# 1. {Maximum and minimum values}[link:stats_rdoc.html#8]
# 1. {Median and percentiles}[link:stats_rdoc.html#9]
# 1. {Examples}[link:stats_rdoc.html#10]
#
