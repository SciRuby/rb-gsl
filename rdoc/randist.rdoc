...
#
# Contents:
# 1. {Introduction}[link:files/randist_rdoc.html#1]
# 1. {The Gaussian Distribution}[link:files/randist_rdoc.html#2]
# 1. {The Gaussian Tail Distribution}[link:files/randist_rdoc.html#3]
#  ...
# and more, see {the GSL reference}[http://www.gnu.org/software/gsl/manual/"target="_top]
# 1. {Shuffling and Sampling}[link:files/randist_rdoc.html#7]
#
...
#
#
# == {}[link:files/index_rdoc.html"name="2] The Gaussian Distribution
# ---
...
#   deviation <tt>sigma</tt>.
#
# == {}[link:files/index_rdoc.html"name="3] The Gaussian Tail Distribution
# ---
...
#
# == {}[link:files/index_rdoc.html"name="4] The Bivariate Gaussian Distribution
# ---
...
#
# == {}[link:files/index_rdoc.html"name="5] The Exponential Distribution
# ---
...
#
# == {}[link:files/index_rdoc.html"name="6] The Laplace Distribution
# ---
# * GSL::Rng#laplace(a)
...
#
# == {}[link:files/index_rdoc.html"name="7] Shuffling and Sampling
# ---
# * GSL::Rng#shuffle(v, n)
#
#   This randomly shuffles the order of <tt>n</tt> objects, 
#   stored in the {GSL::Vector}[link:files/vector_rdoc.html] object <tt>v</tt>. 
# ---
# * GSL::Rng#choose(v, k)
#
#   This returns a {GSL::Vector}[link:files/vector_rdoc.html] object with <tt>k</tt> objects 
#   taken randomly from the {GSL::Vector}[link:files/vector_rdoc.html] object <tt>v</tt>. 
#
...
#
# {prev}[link:files/qrng_rdoc.html]
# {next}[link:files/stats_rdoc.html]
#
