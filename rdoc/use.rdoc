#
# = Using Ruby/GSL
# == {}[link:files/index_rdoc.html"name="1] Installation
# See {here}[link:files/index_rdoc.html].
#
# == {}[link:files/index_rdoc.html"name="2] Load the library
# Put at the head of your scripts,
#     
#     require 'rubygems' # if installed via RubyGems
#     require 'gsl'
#
# == {}[link:files/index_rdoc.html"name="3] Naming conventions, C Structs and Ruby Classes
#
...
#
# == {}[link:files/index_rdoc.html"name="4] Examples
...
#
# == {}[link:files/index_rdoc.html"name="5] Modules and Classes
...
#     * NUM (Module)
#
# {prev}[link:files/intro_rdoc.html]
# {next}[link:files/ehandling_rdoc.html]
#
