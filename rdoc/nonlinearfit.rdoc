...
#
# Contents:
# 1. {Overview}[link:files/nonlinearfit_rdoc.html#1]
# 1. {Initializing the Solver}[link:files/nonlinearfit_rdoc.html#2]
# 1. {GSL::MultiFit::FdfSolver class}[link:files/nonlinearfit_rdoc.html#2.1]
# 1. {Providing the function to be minimized}[link:files/nonlinearfit_rdoc.html#3]
# 1. {GSL::MultiFit::Function_fdf class}[link:files/nonlinearfit_rdoc.html#3.1]
# 1. {Iteration}[link:files/nonlinearfit_rdoc.html#4]
# 1. {Search Stopping Parameters}[link:files/nonlinearfit_rdoc.html#5]
# 1. {Computing the covariance matrix of best fit parameters}[link:files/nonlinearfit_rdoc.html#6]
# 1. {Higher level interfaces}[link:files/nonlinearfit_rdoc.html#7]
# 1. {Examples}[link:files/nonlinearfit_rdoc.html#8]
# 1. {Fitting to user-defined functions}[link:files/nonlinearfit_rdoc.html#8.1]
# 1. {Fitting to built-in functions}[link:files/nonlinearfit_rdoc.html#8.2]
#
# == {}[link:files/index_rdoc.html"name="1] Overview
...
#
# == {}[link:files/index_rdoc.html"name="2] Initializing the Solver 
#
# === {}[link:files/index_rdoc.html"name="2.1] GSL::MultiFit::FdfSolver class
# ---
...
#   initial guess of the parameters <tt>x</tt> is given by a {GSL::Vector}[link:files/vector_rdoc.html] object.
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Providing the function to be minimized
# === {}[link:files/index_rdoc.html"name="3.1] GSL::MultiFit::Function_fdf class
# ---
...
#       
# == {}[link:files/index_rdoc.html"name="4] Iteration
# ---
...
#
#
# == {}[link:files/index_rdoc.html"name="5] Search Stopping Parameters
...
#
#
# == {}[link:files/index_rdoc.html"name="6] Computing the covariance matrix of best fit parameters
# ---
...
#
# == {}[link:files/index_rdoc.html"name="7] Higher level interfaces
# ---
...
#
#   See {Linear fitting}[link:files/fit_rdoc.html#2.3] for linear and polynomical fittings.
#
# == {}[link:files/index_rdoc.html"name="8] Examples
# === {}[link:files/index_rdoc.html"name="8.1] Fitting to user-defined functions
#
...
#
#
# === {}[link:files/index_rdoc.html"name="8.2] Fitting to built-in functions
#   #!/usr/bin/env ruby
#   require("gsl")
#   include MultiFit
#
...
#
#
# {prev}[link:files/fit_rdoc.html]
# {next}[link:files/bspline_rdoc.html]
#
