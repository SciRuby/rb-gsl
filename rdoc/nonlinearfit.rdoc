...
#
# Contents:
# 1. {Overview}[link:nonlinearfit_rdoc.html#1]
# 1. {Initializing the Solver}[link:nonlinearfit_rdoc.html#2]
#    1. {GSL::MultiFit::FdfSolver class}[link:nonlinearfit_rdoc.html#2.1]
# 1. {Providing the function to be minimized}[link:nonlinearfit_rdoc.html#3]
#    1. {GSL::MultiFit::Function_fdf class}[link:nonlinearfit_rdoc.html#3.1]
# 1. {Iteration}[link:nonlinearfit_rdoc.html#4]
# 1. {Search Stopping Parameters}[link:nonlinearfit_rdoc.html#5]
# 1. {Computing the covariance matrix of best fit parameters}[link:nonlinearfit_rdoc.html#6]
# 1. {Higher level interfaces}[link:nonlinearfit_rdoc.html#7]
# 1. {Examples}[link:nonlinearfit_rdoc.html#8]
#    1. {Fitting to user-defined functions}[link:nonlinearfit_rdoc.html#8.1]
#    1. {Fitting to built-in functions}[link:nonlinearfit_rdoc.html#8.2]
#
...
#
#   See {Linear fitting}[link:fit_rdoc.html#2.3] for linear and polynomical fittings.
#
