...
# = Permutations
# Contents:
# 1. {Permuation allocations}[link:perm_rdoc.html#1]
# 1. {Methods}[link:perm_rdoc.html#2]
#    1. {Accessing permutation elements}[link:perm_rdoc.html#2.1]
#    1. {Permuation properties}[link:perm_rdoc.html#2.2]
#    1. {Permuation functions}[link:perm_rdoc.html#2.3]
#    1. {Reading and writing permutations}[link:perm_rdoc.html#2.4]
# 1. {Permutations in cyclic form}[link:perm_rdoc.html#2.5]
# 1. {Applying Permutations}[link:perm_rdoc.html#3]
#
