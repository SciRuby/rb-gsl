...
# 1. {Modules and classes}[link:eigen_rdoc.html#1]
# 1. {Real Symmetric Matrices}[link:eigen_rdoc.html#2]
# 1. {Complex Hermitian Matrices}[link:eigen_rdoc.html#3]
# 1. {Real Nonsymmetric Matrices}[link:eigen_rdoc.html#4] (>= GSL-1.9)
# 1. {Real Generalized Symmetric-Definite Eigensystems}[link:eigen_rdoc.html#5] (>= GSL-1.10)
# 1. {Complex Generalized Hermitian-Definite Eigensystems}[link:eigen_rdoc.html#6] (>= GSL-1.10)
# 1. {Real Generalized Nonsymmetric Eigensystems}[link:eigen_rdoc.html#7] (>= GSL-1.10)
# 1. {Sorting Eigenvalues and Eigenvectors }[link:eigen_rdoc.html#8]
#
