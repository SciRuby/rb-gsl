#
# = Eigensystems
# === {}[link:files/index_rdoc.html"name="0.1] Contentes
# 1. {Modules and classes}[link:files/eigen_rdoc.html#1]
# 1. {Real Symmetric Matrices}[link:files/eigen_rdoc.html#2]
# 1. {Complex Hermitian Matrices}[link:files/eigen_rdoc.html#3]
# 1. {Real Nonsymmetric Matrices}[link:files/eigen_rdoc.html#4] (>= GSL-1.9)
# 1. {Real Generalized Symmetric-Definite Eigensystems}[link:files/eigen_rdoc.html#5] (>= GSL-1.10)
# 1. {Complex Generalized Hermitian-Definite Eigensystems}[link:files/eigen_rdoc.html#6] (>= GSL-1.10)
# 1. {Real Generalized Nonsymmetric Eigensystems}[link:files/eigen_rdoc.html#7] (>= GSL-1.10)
# 1. {Sorting Eigenvalues and Eigenvectors }[link:files/eigen_rdoc.html#8]
#
# == {}[link:files/index_rdoc.html"name="1] Modules and classes
#
# * GSL
#   * Eigen
#     * EigenValues < Vector
...
#       * Workspace (Class)
#
# == {}[link:files/index_rdoc.html"name="2] Real Symmetric Matrices, GSL::Eigen::Symm module
# === {}[link:files/index_rdoc.html"name="2.1] Workspace classes
# ---
...
#
#
# === {}[link:files/index_rdoc.html"name="2.2] Methods to solve eigensystems
# ---
# * GSL::Eigen::symm(A)
...
#
# == {}[link:files/index_rdoc.html"name="3] Complex Hermitian Matrices
# ---
# * GSL::Eigen::herm(A)
...
#
#
# == {}[link:files/index_rdoc.html"name="4] Real Nonsymmetric Matrices (>= GSL-1.9)
#
# ---
...
#
# == {}[link:files/index_rdoc.html"name="5] Real Generalized Symmetric-Definite Eigensystems (GSL-1.10)
...
#
# == {}[link:files/index_rdoc.html"name="6] Complex Generalized Hermitian-Definite Eigensystems (>= GSL-1.10)
...
#   On output, <tt>B</tt> contains its Cholesky decomposition.
#
# == {}[link:files/index_rdoc.html"name="7] Real Generalized Nonsymmetric Eigensystems (>= GSL-1.10)
#
# ---
...
#   the left and right Schur vectors and returns them.
#
# == {}[link:files/index_rdoc.html"name="8] Sorting Eigenvalues and Eigenvectors
# ---
...
#   The sorting is carried out <tt>in-place</tt>.
#
# ---
...
#   being complex. 
#
# {prev}[link:files/linalg_rdoc.html]
# {next}[link:files/fft_rdoc.html]
#
