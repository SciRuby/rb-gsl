...
# Contents:
# 1. {Mathematical Definitions}[link:files/fft_rdoc.html#1]
# 1. {Complex data FFTs}[link:files/fft_rdoc.html#2]
# 1. {Overview of complex data FFTs}[link:files/fft_rdoc.html#2.1]
# 1. {Radix-2 FFT routines for complex data}[link:files/fft_rdoc.html#2.2]
# 1. {Example of the complex Radix-2 FFT}[link:files/fft_rdoc.html#2.2.1]
# 1. {Mixed-radix FFT routines for complex data}[link:files/fft_rdoc.html#2.3]
# 1. {GSL::FFT::ComplexWavetable class}[link:files/fft_rdoc.html#2.3.1]
# 1. {GSL::FFT::ComplexWorkspace class}[link:files/fft_rdoc.html#2.3.2]
# 1. {Methods to compute the transform}[link:files/fft_rdoc.html#2.3.3]
# 1. {Example of the mixed-radix FFT}[link:files/fft_rdoc.html#2.3.4]
# 1. {Real data FFTs}[link:files/fft_rdoc.html#3]
# 1. {Overview of real data FFTs}[link:files/fft_rdoc.html#3.1]
# 1. {Radix-2 FFT routines for real data}[link:files/fft_rdoc.html#3.2]
# 1. {Mixed-radix FFT routines for real data}[link:files/fft_rdoc.html#3.3]
# 1. {Data storage scheme}[link:files/fft_rdoc.html#3.3.1]
# 1. {Wavetable and Workspace classes}[link:files/fft_rdoc.html#3.3.2]
# 1. {Methods for real FFTs}[link:files/fft_rdoc.html#3.3.3]
# 1. {Examples}[link:files/fft_rdoc.html#3.3.4]
#
# == {}[link:files/index_rdoc.html"name="1] Mathematical Definitions 
...
#
#
# == {}[link:files/index_rdoc.html"name="2] Complex data FFTs
# === {}[link:files/index_rdoc.html"name="2.1] Overview of complex data FFTs
# The complex data FFT routines are provided as instance methods of
# {GSL::Vector::Complex}[link:files/vector_complex_rdoc.html].
#
...
#
# {GSL::Vector::Complex}[link:files/vector_complex_rdoc.html] provides four methods for
...
#   for even lengths, but not for odd lengths.
#
# === {}[link:files/index_rdoc.html"name="2.2] Radix-2 FFT routines for complex data
...
#
# ==== {}[link:files/index_rdoc.html"name="2.2.1] Example of complex Radix-2 FFT
...
#         end
#
# === {}[link:files/index_rdoc.html"name="2.3] Mixed-radix FFT routines for complex data
#
# ==== {}[link:files/index_rdoc.html"name="2.3.1] GSL::FFT::ComplexWavetable class
# ---
...
#
#
# ==== {}[link:files/index_rdoc.html"name="2.3.2] GSL::FFT::ComplexWorkspace class
# ---
...
#
# ==== {}[link:files/index_rdoc.html"name="2.3.3] Methods to compute transform
...
# #    * <tt>GSL::SUCCESS</tt>: if no errors were detected.
# #    * <tt>GSL::EDOM</tt>: the length of the data <tt>n</tt> is not a positive integer (i.e. <tt>n</tt> is zero),
# #    * <tt>GSL::EINVAL</tt>: the length of the data <tt>n</tt> and the length used to compute the given wavetable do not match.
#
# ==== {}[link:files/index_rdoc.html"name="2.3.4] Example to use the mixed-radix FFT algorithm
#       require 'gsl'
#       include GSL
#
#       n = 630
...
#       end
#
# == {}[link:files/index_rdoc.html"name="3] Real data FFTs
# === {}[link:files/index_rdoc.html"name="3.1] Overview of real data FFTs 
#
# The functions for real data FFTs are provided as instance methods of
# {GSL::Vector}[link:files/vector.class].  While they are similar to those for
...
# are instances of {GSL::Vector}[link:files/vector_rdoc.html].
#
...
#
# === {}[link:files/index_rdoc.html"name="3.2] Radix-2 FFT routines for real data
# The routines for readix-2 real FFTs are provided as instance methods of
# {GSL::Vector}[link:files/vector_rdoc.html].
#
# <b>The FFT methods described below return FFTed data, and the input vector is
...
#
# == {}[link:files/index_rdoc.html"name="4] Mixed-radix FFT routines for real data
#
...
#
#
# === {}[link:files/index_rdoc.html"name="4.1] Data storage scheme
#
...
#
# ==== {}[link:files/index_rdoc.html"name="4.1.1] Wavetable and Workspace classes
# ---
...
#
# ==== {}[link:files/index_rdoc.html"name="4.1.2] Methods for mixed-radix real FFTs
#
...
#
#
# == {}[link:files/index_rdoc.html"name="5] Examples
#
# === {}[link:files/index_rdoc.html"name="5.1] Example 1
#
#     #!/usr/bin/env ruby
#     require("gsl")
#     include GSL
...
#
# === {}[link:files/index_rdoc.html"name="5.2] Example 2
#     #!/usr/bin/env ruby
#     require("gsl")
#     include GSL
#
...
#
# {prev}[link:files/eigen_rdoc.html]
# {next}[link:files/wavelet_rdoc.html]
#
