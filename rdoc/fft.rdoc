...
# Contents:
# 1. {Mathematical Definitions}[link:fft_rdoc.html#1]
# 1. {Complex data FFTs}[link:fft_rdoc.html#2]
#    1. {Overview of complex data FFTs}[link:fft_rdoc.html#2.1]
#    1. {Radix-2 FFT routines for complex data}[link:fft_rdoc.html#2.2]
#       1. {Example of the complex Radix-2 FFT}[link:fft_rdoc.html#2.2.1]
#    1. {Mixed-radix FFT routines for complex data}[link:fft_rdoc.html#2.3]
#       1. {GSL::FFT::ComplexWavetable class}[link:fft_rdoc.html#2.3.1]
#       1. {GSL::FFT::ComplexWorkspace class}[link:fft_rdoc.html#2.3.2]
#       1. {Methods to compute the transform}[link:fft_rdoc.html#2.3.3]
#       1. {Example of the mixed-radix FFT}[link:fft_rdoc.html#2.3.4]
# 1. {Real data FFTs}[link:fft_rdoc.html#3]
#    1. {Overview of real data FFTs}[link:fft_rdoc.html#3.1]
#    1. {Radix-2 FFT routines for real data}[link:fft_rdoc.html#3.2]
#    1. {Mixed-radix FFT routines for real data}[link:fft_rdoc.html#3.3]
#       1. {Data storage scheme}[link:fft_rdoc.html#3.3.1]
#       1. {Wavetable and Workspace classes}[link:fft_rdoc.html#3.3.2]
#       1. {Methods for real FFTs}[link:fft_rdoc.html#3.3.3]
#       1. {Examples}[link:fft_rdoc.html#3.3.4]
#
