...
#
# 1. {Overview}[link:bspline_rdoc.html#1]
# 1. {Initializing the B-splines solver}[link:bspline_rdoc.html#2]
# 1. {Constructing the knots vector}[link:bspline_rdoc.html#3]
# 1. {Evaluation of B-splines}[link:bspline_rdoc.html#4]
#
