...
#
# 1. {Overview}[link:files/bspline_rdoc.html#1]
# 1. {Initializing the B-splines solver}[link:files/bspline_rdoc.html#2]
# 1. {Constructing the knots vector}[link:files/bspline_rdoc.html#3]
# 1. {Evaluation of B-splines}[link:files/bspline_rdoc.html#4]
#
...
#
# == {}[link:files/index_rdoc.html"name="2] Initializing the B-splines solver 
# ---
...
#
# == {}[link:files/index_rdoc.html"name="3] Constructing the knots vector 
# ---
...
# == {}[link:files/index_rdoc.html"name="4] Evaluation of B-splines 
# ---
...
#
# {prev}[link:files/nonlinearfit_rdoc.html]
# {next}[link:files/const_rdoc.html]
#
