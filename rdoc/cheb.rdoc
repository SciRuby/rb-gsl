...
#
# 1. {GSL::Cheb class}[link:files/cheb_rdoc.html#1]
# 1. {Chebyshev Series Evaluation}[link:files/cheb_rdoc.html#2]
# 1. {Derivatives and Integrals}[link:files/cheb_rdoc.html#3]
# 1. {Examples}[link:files/cheb_rdoc.html#4]
#
# == {}[link:files/index_rdoc.html"name="1] <tt>GSL::Cheb</tt> class
#
# ---
# * GSL::Cheb.alloc(n) 
#
...
# * GSL::Cheb#init(f, a, b)
#
#   This computes the Chebyshev approximation the function <tt>f</tt> over the range (<tt>a,b</tt>) to the previously specified order. Where <tt>f</tt> is a {GSL::Function}[link:files/function_rdoc.html] object. The computation of the Chebyshev approximation is an O(n^2) process, and requires <tt>n</tt> function evaluations.
#
...
#       cs.init(f, 0, 1)
#
# == {}[link:files/index_rdoc.html"name="2] Chebyshev Series Evaluation
# ---
# * GSL::Cheb#eval(x)
#
...
#
# == {}[link:files/index_rdoc.html"name="3] Derivatives and Integrals 
#
# ---
# * GSL::Cheb#calc_deriv()
# * GSL::Cheb#deriv()
...
#
# {prev}[link:files/diff_rdoc.html]
# {next}[link:files/sum_rdoc.html]
#
