...
#
# Contents:
# 1. {Overview}[link:files/fit_rdoc.html#1]
# 1. {Linear regression}[link:files/fit_rdoc.html#2]
#    1. {Module functions for linear regression}[link:files/fit_rdoc.html#2.1]
# 1. {Linear fitting without a constant term}[link:files/fit_rdoc.html#3]
# 1. {Multi-parameter fitting}[link:files/fit_rdoc.html#4]
#    1. {GSL::MultiFit::Workspace class}[link:files/fit_rdoc.html#4.1]
#    1. {Module functions}[link:files/fit_rdoc.html#4.2]
#    1. {Higer level interface}[link:files/fit_rdoc.html#4.3]
#    1. {NDLINEAR: multi-linear, multi-parameter least squares fitting}[link:files/ndlinear_rdoc.html] (GSL extension)
# 1. {Examples}[link:files/fit_rdoc.html#5]
#    1. {Linear regression}[link:files/fit_rdoc.html#5.1]
#    1. {Exponential fitting}[link:files/fit_rdoc.html#5.2]
#    1. {Multi-parameter fitting}[link:files/fit_rdoc.html#5.3]
#
...
#
#
# == {}[link:files/index_rdoc.html"name="2] Linear regression
...
# <tt>w_i = 1</tt>.
#
# === {}[link:files/index_rdoc.html"name="2.1] Module functions for linear regression
# ---
# * GSL::Fit::linear(x, y)
#
...
#
# == {}[link:files/index_rdoc.html"name="3] Linear fitting without a constant term
# ---
# * GSL::Fit::mul(x, y)
#
...
#   The returned value is an array of <tt>[y, yerr]</tt>.
#
# == {}[link:files/index_rdoc.html"name="4] Multi-parameter fitting
# === {}[link:files/index_rdoc.html"name="4.1] GSL::MultiFit::Workspace class
# ---
...
#
# === {}[link:files/index_rdoc.html"name="4.2] Module functions
# ---
...
#   {GSL::Vector}[link:files/vector_rdoc.html] object which contains the best-fit parameters,
#   and <tt>cov</tt> is the variance-covariance matrix as a 
#   {GSL::Matrix}[link:files/matrix_rdoc.html] object.
#
...
#
# === {}[link:files/index_rdoc.html"name="4.3] Higer level interface
#
# ---
...
# === {}[link:files/index_rdoc.html"name="5.1] Linear regression
#      #!/usr/bin/env ruby
#      require("gsl")
#      include GSL::Fit
#
...
#      printf("# chisq = %g\n", chisq);
#
# === {}[link:files/index_rdoc.html"name="5.2] Exponential fitting
#     #!/usr/bin/env ruby
#     require("gsl")
#
#     # Create data
...
#
# === {}[link:files/index_rdoc.html"name="5.3] Multi-parameter fitting
#      #!/usr/bin/env ruby
#      require("gsl")
...
#
# {prev}[link:files/multimin_rdoc.html]
# {next}[link:files/nonlinearfit_rdoc.html]
#
