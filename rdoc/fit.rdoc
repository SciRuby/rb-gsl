...
#
# Contents:
# 1. {Overview}[link:fit_rdoc.html#1]
# 1. {Linear regression}[link:fit_rdoc.html#2]
#    1. {Module functions for linear regression}[link:fit_rdoc.html#2.1]
# 1. {Linear fitting without a constant term}[link:fit_rdoc.html#3]
# 1. {Multi-parameter fitting}[link:fit_rdoc.html#4]
#    1. {GSL::MultiFit::Workspace class}[link:fit_rdoc.html#4.1]
#    1. {Module functions}[link:fit_rdoc.html#4.2]
#    1. {Higer level interface}[link:fit_rdoc.html#4.3]
#    1. {NDLINEAR: multi-linear, multi-parameter least squares fitting}[link:ndlinear_rdoc.html] (GSL extension)
# 1. {Examples}[link:fit_rdoc.html#5]
#    1. {Linear regression}[link:fit_rdoc.html#5.1]
#    1. {Exponential fitting}[link:fit_rdoc.html#5.2]
#    1. {Multi-parameter fitting}[link:fit_rdoc.html#5.3]
#
