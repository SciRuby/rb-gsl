...
{ 
  ...
  // class functions to convert NMatrix to GSL::Vector
  rb_define_singleton_method(cgsl_vector, "nm_to_gslv",
    rb_gsl_nmatrix_to_gsl_vector, 1);
  rb_define_singleton_method(cgsl_vector_int, "nm_to_gslv",
    rb_gsl_nmatrix_to_gsl_vector_int, 1);
  rb_define_singleton_method(cgsl_vector_complex, "nm_to_gslv",
    rb_gsl_nmatrix_to_gsl_vector_complex, 1);
  
  // class functions to convert NMatrix to GSL::Matrix
  rb_define_singleton_method(cgsl_matrix, "nm_to_gslm", 
    rb_gsl_nmatrix_to_gsl_matrix, 1);
  rb_define_singleton_method(cgsl_matrix_int, "nm_to_gslm", 
    rb_gsl_nmatrix_to_gsl_matrix_int, 1);
  rb_define_singleton_method(cgsl_matrix_complex, "nm_to_gslm",
    rb_gsl_nmatrix_to_gsl_matrix_complex, 1);
